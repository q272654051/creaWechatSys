...
function pagerUtilTextAuto(curPage, end, pageSize, start, totalPage, totalRow) {
    ...
    if (curPage <= 3) {
        if (totalPage < 5) {
            for (var j = 0; j < totalPage; j++) {
                pageUL.append("<li id='TextAuto" + (j + 1) + "'><a href='javascript:;' onclick='loadTextAuto(" + (j + 1) + ")'>" + (j + 1) + "</a></li>");
            }
        } else {
        ...
        colorFlagTextAuto = "TextAuto"+curPage;
        ...
        for (var j = curPage - 2; j < curPage + 3; j++) {
            pageUL.append("<li id='TextAuto" + (j + 1) + "'><a href='javascript:;' onclick='loadTextAuto(" + j + ")'>" + j + "</a></li>");
        }
        colorFlagTextAuto = "TextAuto"+curPage + 1;
    }
    ...
    $('#' + colorFlagTextAuto).addClass('active');
}
